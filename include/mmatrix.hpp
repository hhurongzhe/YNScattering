...
std::complex<double> m11(double t, const YN::YN_configs &configs, std::vector<double> &phase_uncoupled,
...
std::complex<double> m10(double t, const YN::YN_configs &configs, std::vector<double> &phase_uncoupled,
                         std::vector<double> &phase_coupled)
{
    double p_lab_now = configs.plab_dcs;
    double mu = configs.mass_proton * configs.mass_sigmap / (configs.mass_proton + configs.mass_sigmap);
...
std::complex<double> mpm(double t, const YN::YN_configs &configs, std::vector<double> &phase_uncoupled,
                         std::vector<double> &phase_coupled)
{
    double p_lab_now = configs.plab_dcs;
    double mu = configs.mass_proton * configs.mass_sigmap / (configs.mass_proton + configs.mass_sigmap);
...
std::complex<double> m01(double t, const YN::YN_configs &configs, std::vector<double> &phase_uncoupled,
                         std::vector<double> &phase_coupled)
{
    double p_lab_now = configs.plab_dcs;
    double mu = configs.mass_proton * configs.mass_sigmap / (configs.mass_proton + configs.mass_sigmap);
...
std::complex<double> m00(double t, const YN::YN_configs &configs, std::vector<double> &phase_uncoupled,
                         std::vector<double> &phase_coupled)
{
    double p_lab_now = configs.plab_dcs;
    double mu = configs.mass_proton * configs.mass_sigmap / (configs.mass_proton + configs.mass_sigmap);
...
std::complex<double> mss(double t, const YN::YN_configs &configs, std::vector<double> &phase_uncoupled,
                         std::vector<double> &phase_coupled)
{
    double p_lab_now = configs.plab_dcs;
    double mu = configs.mass_proton * configs.mass_sigmap / (configs.mass_proton + configs.mass_sigmap);
